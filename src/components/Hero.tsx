...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center relative bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900 text-white">
      <div 
      ...
      <div className="text-center z-10 max-w-4xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in">
          <button className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-full font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/25">
            View My Work
          </button>
          <button className="border border-orange-400 text-orange-100 hover:bg-orange-600 hover:text-white px-8 py-3 rounded-full font-medium transition-all duration-300 hover:scale-105">
            Get In Touch
          </button>
        </div>
      </div>
