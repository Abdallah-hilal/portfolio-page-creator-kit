  ...
  return (
    <>
      ...
      {isHomePage && activeItem === "Home" && (
        <Button className="hidden lg:flex fixed top-6 right-60 z-50 bg-[#F17C58] hover:bg-[#E16A47] text-white px-4 py-2 rounded-lg font-semibold items-center gap-2 shadow-md hover:shadow-lg transition-all">
